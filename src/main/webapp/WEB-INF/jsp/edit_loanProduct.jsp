...
<body>
    <div class="container">
        <div class="form-container">
            <h2 class="text-center">Edit Loan Product</h2>
            <form:form method="post" action="${pageContext.request.contextPath}/loanProducts/update" modelAttribute="loanProduct">
